...
public class Ut implements OpenStreetMapConstants, OpenStreetMapViewConstants, PoiConstants {
	...
	public static int IconResId(int id) {

		if (id < 0 || id > POI_LAST)
			return R.drawable.poi;

		return POI_RES_ID[id];
	}
...
//		}     
	...
	public static Intent SendMail(String subject, String text) {
		final String[] email = {"sm@venus.ru"};
